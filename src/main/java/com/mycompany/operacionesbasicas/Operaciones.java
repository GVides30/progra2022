...
public class Operaciones extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Operaciones básicas</title>");
            out.println("</head>");
            out.println("<body>");
            ProcesoOperacion proceso = new ProcesoOperacion();
            double n1 = Integer.parseInt(request.getParameter("num1"));
            double n2 = Integer.parseInt(request.getParameter("num2"));
            String tipoOperacion = request.getParameter("Operaciones");
            out.println("<h1>Resultado</h1>");
        

            double resultado = proceso.Resolucion(n1, n2, tipoOperacion);
            
            out.print("<p>Resultado: "+resultado+"</p>");
              out.print("<p><a href='index.html'>Nueva operación</a></p>");
            out.println("</body>");
            out.println("</html>");
        }
    }
